...
class DQN_synthesized(object):
    ...
    def __init__(self, conf, action_size, state_size, device):
        ...
        self.translate = dictionary_of_actions_synthesized(self.num_qubits)
        self.rev_translate = dictionary_of_actions_synthesized(self.num_qubits)
